...
if ( ! function_exists('nexio_get_not_selected_text') ) {
	/**
	 ...
	 */
	function nexio_get_not_selected_text( $label ) {
		return apply_filters( 'nexio_filter_not_selected_text',
								sprintf( apply_filters( 'nexio_filter_not_selected_mask', __( '- %s -', 'nexio' ) ), $label )
							);
	}
}

if ( ! function_exists( 'nexio_get_list_range' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'nexio_get_list_styles' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'nexio' ), $i );
		}
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'nexio' ),
			'no'  => esc_html__( 'No', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function nexio_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'nexio' ),
				0         => esc_html__( 'No', 'nexio' ),
			)
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'nexio_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'nexio' ),
			'off' => esc_html__( 'Off', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'nexio' ),
			'hide' => esc_html__( 'Hide', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'nexio' ),
			'hidden'  => esc_html__( 'Hidden', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_directions' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'nexio' ),
			'vertical'   => esc_html__( 'Vertical', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'nexio' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'nexio' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'nexio' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'nexio' ),
...
if ( ! function_exists( 'nexio_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'nexio' ),
				'icon'    => esc_html__( 'Icon', 'nexio' ),
				'icons'   => esc_html__( 'Icons', 'nexio' ),
				'zoom'    => esc_html__( 'Zoom', 'nexio' ),
				'fade'    => esc_html__( 'Fade', 'nexio' ),
				'slide'   => esc_html__( 'Slide', 'nexio' ),
				'pull'    => esc_html__( 'Pull', 'nexio' ),
				'border'  => esc_html__( 'Border', 'nexio' ),
				'excerpt' => esc_html__( 'Excerpt', 'nexio' ),
				'info'    => esc_html__( 'Info', 'nexio' ),
			)
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'nexio_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'nexio' ),
				'fullpost' => esc_html__( 'Full post', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'nexio' ),
...
if ( ! function_exists( 'nexio_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = nexio_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			nexio_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = nexio_array_merge( array( 'hide' => nexio_get_not_selected_text( esc_html__( 'Select widgets', 'nexio' ) ) ), $list );
		}
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'nexio' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'nexio' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'nexio' ),
...
if ( ! function_exists( 'nexio_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'nexio' ),
				'below' => esc_html__( 'Below the content', 'nexio' ),
				'float' => esc_html__( 'Floating bar', 'nexio' ),
			)
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'nexio_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'nexio_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'nexio_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'nexio_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'nexio' ),
			'over'    => esc_html__( 'Over', 'nexio' ),
			'under'   => esc_html__( 'Under', 'nexio' ),
		);
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'nexio_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? nexio_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'nexio' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'nexio_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'nexio' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'nexio' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'nexio_filter_allow_fullscreen', $force_fullscreen || nexio_get_theme_setting( 'allow_fullscreen' ) || nexio_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'nexio' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'nexio' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'nexio_filter_list_body_styles', $list );
		return $prepend_inherit
					? nexio_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'nexio_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'nexio_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'nexio' ),
...
if ( ! function_exists( 'nexio_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'nexio' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'nexio' ),
...
if ( ! function_exists( 'nexio_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'nexio' ),
				'date'       => esc_html__( 'Published date', 'nexio' ),
				'modified'   => esc_html__( 'Modified date', 'nexio' ),
				'views'      => esc_html__( 'Views', 'nexio' ),
				'likes'      => esc_html__( 'Likes', 'nexio' ),
				'comments'   => esc_html__( 'Comments', 'nexio' ),
				'share'      => esc_html__( 'Share links', 'nexio' ),
				'categories' => esc_html__( 'Categories', 'nexio' ),
				'edit'       => esc_html__( 'Edit link', 'nexio' ),
			)
		);
...
if ( ! function_exists( 'nexio_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function nexio_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'nexio_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'nexio_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function nexio_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'nexio' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'nexio' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'nexio_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? nexio_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'nexio_get_list_single_styles' ) ) {
	/**
...
if ( ! function_exists( 'nexio_get_list_posts' ) ) {
	...
	function nexio_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		...
		$list = nexio_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? nexio_get_not_selected_text( esc_html__( 'Not selected', 'nexio' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'nexio_get_list_users' ) ) {
	/**
