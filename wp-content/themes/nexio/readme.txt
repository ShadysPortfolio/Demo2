...
Please install and activate it before starting to use the theme Nexio.
...
Theme documentation is available on https://nexio.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Nexio is Fontello.
