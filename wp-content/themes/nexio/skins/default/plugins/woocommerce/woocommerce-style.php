...
if ( ! function_exists( 'nexio_woocommerce_get_css' ) ) {
	add_filter( 'nexio_filter_get_css', 'nexio_woocommerce_get_css', 10, 2 );
	function nexio_woocommerce_get_css( $css, $args ) {
...
$fdir = nexio_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
