...
if ( ! function_exists( 'nexio_tribe_events_get_css' ) ) {
	add_filter( 'nexio_filter_get_css', 'nexio_tribe_events_get_css', 10, 2 );
	function nexio_tribe_events_get_css( $css, $args ) {
