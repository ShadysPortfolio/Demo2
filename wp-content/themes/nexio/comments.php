	...
	$nexio_show_comments     = nexio_get_value_gp( 'show_comments' ) == 1
									|| ( ! $nexio_full_post_loading
											...
											( 'scroll' != $nexio_posts_navigation
												|| nexio_get_theme_option( 'posts_navigation_scroll_hide_comments' ) == 0
												|| nexio_check_url( '#comments' )
											)
										);
	$nexio_show_button       = ! $nexio_show_comments || nexio_get_theme_option( 'show_comments_button' ) == 1;
	$nexio_open_comments     = nexio_get_value_gp( 'show_comments' ) == 1
									|| ! $nexio_show_button
									|| nexio_get_theme_option( 'show_comments' ) == 'visible'
									|| nexio_check_url( '#comments' );
		...
		<section class="comments_wrap<?php if ( $nexio_open_comments ) { echo ' opened'; } ?>">
			...
			if ( have_comments() ) {
				...
				<div id="comments" class="comments_list_wrap">
					...
					?>
				<?php echo esc_html( _n( 'Comment', 'Comments', $nexio_post_comments, 'nexio' ) ); ?></h3>
			...
			if ( comments_open() ) {
				...
				<div class="comments_form_wrap">
					...
					<?php
					$nexio_form_style = esc_attr( nexio_get_theme_option( 'input_hover' ) );
						...
						'nexio_filter_comment_form_args', array(
							...
							'comment_field'        => nexio_single_comments_field(
								array(
									...
									'field_value'       => '',
									'field_name'        => 'comment',
									'field_title'       => esc_html__( 'Comment', 'nexio' ),
